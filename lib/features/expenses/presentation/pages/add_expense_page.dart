...
class AddExpensePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Use BlocProvider.value to provide the existing singleton instance.
    // We initialize it here to ensure fresh state/group data.
    return BlocProvider.value(value: sl<ExpenseBloc>()..add(ExpenseInitialized(group)), child: const _AddExpenseView());
  }
}
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          NavigationService.pushNamed(AppRoutes.payerSelection);
                        },
                        child: Container(
                      ...
                      GestureDetector(
                        onTap: () {
                          NavigationService.pushNamed(AppRoutes.splitOptions);
                        },
                        child: Container(
                          padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                          decoration: BoxDecoration(
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      NavigationService.pushNamed(AppRoutes.dateSelection);
                    },
                    child: Row(
                      children: [
