...
class ExpenseDetailLoaded extends ExpenseDetailState {
  ...
  const ExpenseDetailLoaded(this.expenseDetail, this.currentUserId, {bool hasChanges = false}) : super(hasChanges: hasChanges);
  ...
  @override
  List<Object?> get props => [expenseDetail, currentUserId, hasChanges];
}
