...
class CreateGroupBloc extends Bloc<CreateGroupEvent, CreateGroupState> {
  ...
  CreateGroupBloc(this._imagePickerService, this._groupInsertIcon, this._groupCreate, this._checkInviteCode) : super(const CreateGroupState()) {
